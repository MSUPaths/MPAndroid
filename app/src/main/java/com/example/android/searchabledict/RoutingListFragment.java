...
public class RoutingListFragment extends Fragment implements
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		RoutingListAdapter adapter = new RoutingListAdapter(getActivity(),
				MapDisplay.curDirections);
	...
	public void onItemClick(AdapterView<?> parent, View view, int position,
		...
		MapDisplay.mDrawerLayout.closeDrawers();
		if (isSoundOn)
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.direction:
			if (MapDisplay.mDrawerLayout.isDrawerOpen(Gravity.END)) {
				MapDisplay.mDrawerLayout.closeDrawers();
			} else {
				MapDisplay.mDrawerLayout.openDrawer(Gravity.END);
			}
			return true;
